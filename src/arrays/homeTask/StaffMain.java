...
public class StaffMain {
    ...
    public static void main(String[] args) {
        ...
        staff[0] = new Staff("Sidorovich", "Ivan", 25, 990.5f, 10);
        staff[3] = new Staff("Sidorov", "Petr", 45, 1420.6f, 15);
        staff[2] = new Staff("Ivanchuk", "Ivan", 37, 1350.7f, 14);
        staff[1] = new Staff("Zhuk", "Petr", 40, 1456.7f, 18);
